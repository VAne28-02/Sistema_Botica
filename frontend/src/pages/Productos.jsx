        ...
        <div className="productos-page">
            ...
            <div className="productos-grid">
                <div className="productos-panel">
                    <h4 className="productos-panel-title">{editingId ? 'Editar Producto' : 'Nuevo Producto'}</h4>
                ...
                <div className="productos-panel">
                    <h4 className="productos-panel-title">Lista de Productos ({productosFiltrados.length})</h4>
                    <input
                        type="text"
